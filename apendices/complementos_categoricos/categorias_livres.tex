...
\begin{lema}\label{lema:decompondo_caminhos_aljava}
    ...
    \begin{displaymath}
        \gamma = \gamma_1 \star \dotsm \star \gamma_{n}.
    \end{displaymath}
\end{lema}
...
\begin{proof}
    ...
    Podemos então formar o caminho composto $\delta \star \gamma_{n+1}: [n+1] \to Q$ que por construção é o único de seu tipo que faz comutar o diagrama abaixo.
    \begin{displaymath}
        \begin{tikzcd}[column sep=1.25cm]
            ...
            & {[n+1]}
            \arrow[rd, dashed, "\delta \star \gamma_{n+1}" description]
            \\ & & Q
        \end{tikzcd}
    \end{displaymath}
    ...
    \begin{displaymath}
        \gamma = \delta \star \gamma_{n+1}.
    \end{displaymath}

    Aplicando a hipótese de indução ao caminho $\delta: [n] \to Q$ obtemos caminhos $\gamma_1, \dots, \gamma_n: [1] \to Q$ tais que $\delta = \gamma_1 \star \dotsm \star \gamma_n$.
    Substituindo isso na igualdade anterior obtemos a decomposição desejada
    \begin{displaymath}
        \gamma = \delta \star \gamma_{n+1} = \gamma_1 \star \dotsm \star \gamma_n \star \gamma_{n+1}. \qedhere
    \end{displaymath}
\end{proof}
