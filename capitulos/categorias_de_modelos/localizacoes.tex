...
A primeira definição de localização que daremos, a qual aparece por exemplo nas referências \cite[Definição 7.30]{heuts_simplicial_2022} e \cite{nlab:localization}, é a versão fraca.
