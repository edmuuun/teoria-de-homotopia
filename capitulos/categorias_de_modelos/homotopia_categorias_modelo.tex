...
Note que, se $\beta: Y \to Z$ é um morfismo \emph{qualquer}, temos a função $\mathsf{M}(X,\beta): \mathsf{M}(X,Y) \to \mathsf{M}(X,Z)$ de pushforward (pós-composição) ao longo de $\beta$.
