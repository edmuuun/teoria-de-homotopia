...
\begin{proof}
  ...
  \end{displaymath}
  Além disso, o fato de $i_{0}$ ser uma cofibração trivial segue da hipótese do cilindro $\Cyl(B)$ ser forte de acordo com o \cref{lema:propriedades_objeto_cilindro}.
  ...
  Como $B$ é cofibrante por hipótese, segue da \cref{prop:propriedades_de_preservacao_homotopia_a_direita} que existe uma homotopia à direita de $f$ para $g$ com relação ao objeto de caminhos $P(X)$, ou seja, existe um morfismo $h: B \to P(X)$ tal que $p \circ h = (f,g)$.
  ...
  \begin{displaymath}
    ...
    \end{tikzcd}
  \end{displaymath}
  Sendo $P(X)$ um objeto de caminhos forte, sabemos do \cref{lema:propriedades_objeto_de_caminhos} que $p_{0}: P(X) \to X$ é de fato uma fibração trivial; e ademais, $i: B \sqcup B \to \Cyl(B)$ é uma cofibração pela própria definição de objeto cilindro.
