...
\begin{prop}\label{prop:comparando_homotopia_esquerda_homotopia_direita}
...
\begin{defin}\label{defin:homotopia}
  Seja $(\mathsf{M},\mathcal{W},\mathcal{C},\mathcal{F})$ uma categoria de modelos.
  Dois morfismos $f,\,g: B \to X$ são ditos \text{homotópicos} quando eles são simultaneamente homotópicos à esquerda e também homotópicos à direita.
\end{defin}
